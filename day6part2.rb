...
puts col1.min_by{|x| col1.count(x) }
puts col2.min_by{|x| col2.count(x) }
puts col3.min_by{|x| col3.count(x) }
puts col4.min_by{|x| col4.count(x) }
puts col5.min_by{|x| col5.count(x) }
puts col6.min_by{|x| col6.count(x) }
puts col7.min_by{|x| col7.count(x) }
puts col8.min_by{|x| col8.count(x) }
